...
while($row=mysqli_fetch_array($result))
{
	...
	{
		$a="update activa586 set   status='3'   where  phn='$phn' ";
		mysqli_query($con,$a);
		break;
	}
}
...
while($row=mysqli_fetch_array($result))
{
    if($phn==$row[1] && $row[4]=='2')
	{
		$a="update bike903 set   status='3'   where  phn='$phn' ";
		mysqli_query($con,$a);
		break;
	}
}
...
while($row=mysqli_fetch_array($result))
{
    if($phn==$row[1] && $row[4]=='2')
	{
		$a="update bullet777 set   status='3'   where  phn='$phn' ";
		mysqli_query($con,$a);
		break;
	}
}
...
while($row=mysqli_fetch_array($result))
{
    if($phn==$row[1] && $row[4]=='2')
	{
		$a="update swift685 set   status='3'   where  phn='$phn' ";
		mysqli_query($con,$a);
		break;
	}
}
...
while($row=mysqli_fetch_array($result))
{
    if($phn==$row[1] && $row[4]=='2')
	{
		$a="update ameo298 set   status='3'   where  phn='$phn' ";
		mysqli_query($con,$a);
		break;
	}
}
